...
public class CashCardJsonTest {
    ...
    public void cashCardDeserializationTest() throws IOException {
        ...
        assertThat(this.json.parseObject(expected).id()).isEqualTo(99L);
        assertThat(this.json.parseObject(expected).amount()).isEqualTo(123.45);
    }

    @Test
    void cashCardListSerializationTest() throws IOException {
        assertThat(this.jsonList.write(this.cashCards)).isStrictlyEqualToJson("list.json");
    }
    ...
    void cashCardListDeserializationTest() throws IOException {
        String expected = """
                ...
                """;
        assertThat(this.jsonList.parse(expected)).isEqualTo(this.cashCards);
    }
}
